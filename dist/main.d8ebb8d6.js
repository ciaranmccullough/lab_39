...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Responsive Navbar
  var mainNav = document.getElementById('js-nav');
  ...
  var links = document.querySelectorAll('.nav-links'); // log(links);
  ...
  var lazyImages = [].slice.call(document.querySelectorAll('img.lazy')); // log(lazyImages);
